  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        // La Fabrique PEPPS Brand Colors
        indigo: {
      ...
      keyframes: {
        ...
        "glow": {
          "0%, 100%": { boxShadow: "0 0 20px hsl(var(--sky-blue) / 0.3)" },
          "50%": { boxShadow: "0 0 40px hsl(var(--sky-blue) / 0.6)" }
        }
      },
      animation: {
